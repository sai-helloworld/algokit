...
import { DecentralizedEscrowClient } from '../contracts/clients/DecentralizedEscrowClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: DecentralizedEscrowClient;

describe('DecentralizedEscrow', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new DecentralizedEscrowClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
